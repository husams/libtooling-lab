...
def add_symbols(db: sqlite3.Connection) -> dict[str, int]:
    ...
    rows = (
        ...
        symbol(ids["save"], 1, 13, "c:@F@save#", "app::save", is_definition=1),
        symbol(ids["persist"], 1, 13, "c:@F@persist#", "app::persist"),
        symbol(ids["box"], 2, 7, "c:@S@Box", "app::Box", is_definition=1),
        symbol(ids["field"], 4, 15, "c:@S@Box@FI@value", "app::Box::value"),
        symbol(
            ids["method"],
            1,
            17,
        ...
        *(
        ...
        symbol(1, 5, 12, "c:@T@int", "int", is_external=1),
    )
