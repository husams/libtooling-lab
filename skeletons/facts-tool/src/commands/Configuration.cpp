...
runConfiguration(const cli::ConfigOptions &options) {
  ...
  std::cout << "ast_cache: " << (value->astCache.enabled ? "true" : "false") << '\n';
  std::cout << "ast_cache_dir: " << value->astCache.directory << '\n';
  ...
  std::cout << "ast_cache_source: " << value->astCacheSource << '\n';
  std::cout << "ast_cache_dir_source: " << value->astCacheDirectorySource << '\n';
  std::cout << "extra_args:";
